/* CoderDojo / IT2Pi Rocket Telemetry Project   */
/* 2013.10.27                       */
...
void setup(void) 
{
  ...
  // Checks to make sure it is reading the ADXL345 accelerometer
 ...
 // Finished testing if sensors are online
  ...
  /* For this project, we want 16G max range                           */
  ...
  /* Display some basic information on this ADXL345 */
...
void loop(void) 
{
  ...
  /* First we get the current temperature from the BMP085 */
    ...
    dataFile.println(bmp.pressureToAltitude(seaLevelPressure, event.pressure, temperature)); 
